...
from modules.database import get_partners, get_stats, init_db, log_email, update_influencer, upsert_influencer
...
def _check_config():
    ...
    if not GMAIL_CREDENTIALS_PATH:
        issues.append("GMAIL_CREDENTIALS_PATH eksik")
...
def run_search(hashtags: list[str] = None, keywords: list[str] = None, max_results: int = 100, dry_run: bool = False):
    ...
    for i, profile in enumerate(profiles, 1):
        ...
        update_influencer(
            ...
            niche_tags=str(analysis.get("niches", [])),
        )
